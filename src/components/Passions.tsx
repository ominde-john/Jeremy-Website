      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {skills.map((skill, index) => (
              <ScrollReveal key={index} direction="scale" delay={index * 100}>
                <Card className="bg-slate-800/70 border border-slate-600 hover:border-sky-500/50 transition-all duration-300 hover-lift group">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <ScrollReveal direction="right">
            <Card className="bg-slate-800/70 border border-slate-600 hover:border-emerald-500/50 transition-all duration-300 hover-lift">
              <CardHeader>
                <CardTitle className="text-2xl flex items-center gap-2 text-slate-100">
                  <span className="text-2xl">🚀</span>
                  Professional Goals:
